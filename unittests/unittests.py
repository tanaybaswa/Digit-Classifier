...
class TestRelu(TestCase):
    ...
    def test_simple_two(self):
        ...
        t.call("relu")
        # check that the array0 was changed appropriately
        t.check_array(array0, [1, 0, 3, 0, 5, -6, 7, -8, 9])
        # generate the `assembly/TestRelu_test_simple.s` file and run it through venus
        t.execute()
...
class TestArgmax(TestCase):
    ...
    def test_case_1(self):
        t = AssemblyTest(self, "argmax.s")
        array0 = t.array([200,100, 300, 100, 0])
        t.input_array("a0", array0)
        t.input_scalar("a1", len(array0))
        t.call("argmax")
        t.check_scalar("a0", 2)
...
class TestMatmul(TestCase):
    ...
    def test_diffdd(self):
        self.do_matmul(
            [1,2,1,2,1,2,1,2,1,2], 5, 2,
            [1, 2, 3, 4, 5, 6,1, 2, 3, 4, 5, 6], 2, 6,
...
class TestReadMatrix(TestCase):
    ...
    def test_error_one(self):
        self.do_read_matrix("fopen", 117)

    def test_error_two(self):
        self.do_read_matrix("fclose", 119)

    def test_error_three(self):
        self.do_read_matrix("fread", 118)
...
class TestWriteMatrix(TestCase):
    ...
    def test_error_one(self):
        self.do_write_matrix2("fopen", 112)

    def test_error_two(self):
        self.do_write_matrix2("fwrite", 113)

    def test_error_three(self):
        self.do_write_matrix2("fclose", 114)

    def test_malloc(self):
        self.do_write_matrix2("malloc", 122)
...
class TestClassify(TestCase):
    ...
    def test_simple0_input0(self):
        ...
        t.check_file_output("outputs/test_basic_main/student0.bin", "outputs/test_basic_main/reference0.bin")
        t.check_stdout("2\n")
